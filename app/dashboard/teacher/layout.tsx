  ...
  return (
    <Layout className="min-h-screen">
      <Sider className="h-screen bg-white ">
        ...
        <Divider />
        <div
          className="pl-[10px] font-[14px] h-[25vh] flex flex-col justify-left"
          style={{ fontFamily: "Inter" }}
        >
          {menuItems.slice(0, 2).map((item) => (
            <div
              className={`relative flex items-center justify-start pt-5 pl-5 text-[#565E6C] font-normal ${
        ...
        >
          ...
          <Button
            ...
            className="flex justify-center  mt-[25px] bg-[#636AE8FF] text-[#FFFFFF]"
          >
