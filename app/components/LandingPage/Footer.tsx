...
const Footer = () => {
  return (
    <div className='flex flex-col space-y-4 px-36 bg-[#FAFAFBFF] pt-8 pb-2'>
        ...
        <p className={`text-gray-400 text-sm w-[300px] ${InterFont.className}`}>Streamline the process of creating, managing, and optimizing timetables for students and teachers</p>
