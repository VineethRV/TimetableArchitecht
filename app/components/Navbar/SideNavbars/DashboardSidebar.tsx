...
<div
  ...
  className={`flex relative items-center pl-2 pr-1 py-2 cursor-pointer ${
    pathname == "/dashboard/teacher" || pathname.includes("/dashboard/teacher")
      ? "text-[#636AE8FF]"
      : "text-[#565E6CFF]"
  }`}
>
...
<div
  ...
  className={`flex relative items-center p-2 cursor-pointer ${
    pathname == "/dashboard/rooms" || pathname.includes("/dashboard/rooms")
      ? "text-[#636AE8FF]"
      : "text-[#565E6CFF]"
  }`}
>
...
<div
  ...
  className={`flex relative items-center p-2 cursor-pointer ${
    pathname == "/dashboard/courses" || pathname.includes("/dashboard/courses")
      ? "text-[#636AE8FF]"
      : "text-[#565E6CFF]"
  }`}
>
...
<div
  ...
  className={`flex relative items-center p-2 cursor-pointer ${
    pathname == "/dashboard/section" || pathname.includes("/dashboard/section")
      ? "text-[#636AE8FF]"
      : "text-[#565E6CFF]"
  }`}
>
